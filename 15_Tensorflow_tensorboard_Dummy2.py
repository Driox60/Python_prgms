...
#    summary = sess.run(merged_summary_op, {x: x_train, y_prim: y_train}) 
    print("iteration :", i, "valeurs :", sess.run([a, b]), "cost :")

a_found, b_found, curr_cost = sess.run([a, b, cost], {x: x_train, y_prim: y_train})
print ("a: ", a_found, "b: ", b_found, "cost: ", curr_cost)
